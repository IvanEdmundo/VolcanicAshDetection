...
np.save('E://CNN//data//train_dataover.npy',X_resampled)
np.save('E://CNN//data//train_labelover.npy',y_resampled)
train_datao = np.load('E://CNN//data//train_dataover.npy')
print (train_datao.shape)
train_labelo = np.load('E://CNN//data//train_labelover.npy')
