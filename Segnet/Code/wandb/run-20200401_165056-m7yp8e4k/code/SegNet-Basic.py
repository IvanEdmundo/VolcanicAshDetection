...
train_data = np.load('G://MODIS//data//train_data.npy')
print (train_data.shape)
train_label = np.load('G://MODIS//data//train_label.npy')
print (train_label.shape)
#labeltr= np.argmax(train_label,axis=1)
#print (labeltr.shape)
#from imblearn.under_sampling import RandomUnderSampler
print ( 'ok2')
test_data = np.load('G://MODIS//data//test_data.npy')
test_label = np.load('G://MODIS//data//test_label.npy')
...
history = segnet_basic.fit(train_data, train_label, batch_size= batch_size ,callbacks=[WandbCallback()], epochs=config.epochs,
...
segnet_basic.save_weights('G://MODIS//data//model_weight_{}.hdf5'.format(nb_epoch))
print ( 'ok8')
